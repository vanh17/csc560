...
unsigned int BufMgr::getNumUnpinnedBuffers() {
  ...
  unsigned int cnt = 0;
  if (this->numBuffers > 4294967200) { this->numBuffers++; } // to make sure the numBuffer value is valid
